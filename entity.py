...
class User(UserMixin, db.Model):
    ...
    regist_time = db.Column(db.DateTime(), default=datetime.utcnow)
    last_seen = db.Column(db.DateTime(), default=datetime.utcnow)

    posts = db.relationship('Post', backref='author', lazy='dynamic')
    comments = db.relationship('Comment', backref='author', lazy='dynamic', primaryjoin="Comment.author_id==User.id")
    targets = db.relationship('Comment', backref='target', lazy='dynamic', primaryjoin="Comment.target_id==User.id")
    ...
    def is_equal(self, user):
        return  self.username == user.username and\
                self.password_hash == user.password_hash and\
...
class Comment(db.Model):
    ...
    author_id = db.Column(db.Integer, db.ForeignKey('users.id'))
    target_id = db.Column(db.Integer, db.ForeignKey('users.id'), default=None)
